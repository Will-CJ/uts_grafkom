...
export class Ralts {
    constructor(GL, SHADER_PROGRAM, _position, _Mmatrix, _normal) {
        ...
        const leftLeg = new Cone(GL, SHADER_PROGRAM, _position, _Mmatrix, _normal, leftLegRadius-0.05, 0, 360, 0, 0, leftLegHeight-0.01, 30, WHITE);
        ...
        const rightLeg = new Cone(GL, SHADER_PROGRAM, _position, _Mmatrix, _normal, rightLegRadius-0.05, 0, 360, 0, 0, rightLegHeight-0.01, 30, WHITE);
